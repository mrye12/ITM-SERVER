-- =============================================
-- ADVANCED FINANCIAL MANAGEMENT SCHEMA (FIXED)
...
CREATE TABLE IF NOT EXISTS chart_of_accounts (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_chart_accounts_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
...
CREATE TABLE IF NOT EXISTS financial_transactions (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_financial_transactions_posted_by FOREIGN KEY (posted_by) REFERENCES auth.users(id),
    CONSTRAINT fk_financial_transactions_reversed_by FOREIGN KEY (reversed_by) REFERENCES auth.users(id),
    CONSTRAINT fk_financial_transactions_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
...
CREATE TABLE IF NOT EXISTS bank_accounts (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_bank_accounts_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
...
CREATE TABLE IF NOT EXISTS bank_transactions (
    ...
    reconciled_with UUID REFERENCES financial_transactions(id),
    reconciled_by UUID,
    reconciled_at TIMESTAMPTZ,
    imported_from TEXT, -- Source system
    created_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_bank_transactions_reconciled_by FOREIGN KEY (reconciled_by) REFERENCES auth.users(id)
);
...
CREATE TABLE IF NOT EXISTS budget_plans (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_budget_plans_approved_by FOREIGN KEY (approved_by) REFERENCES auth.users(id),
    CONSTRAINT fk_budget_plans_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
...
CREATE TABLE IF NOT EXISTS financial_reports (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    CONSTRAINT fk_financial_reports_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
...
DO $$ BEGIN
    ...
    RAISE NOTICE 'All connected to Supabase with proper foreign keys!';
END $$;
